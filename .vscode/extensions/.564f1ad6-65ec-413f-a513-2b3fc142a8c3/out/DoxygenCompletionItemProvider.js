...
class DoxygenCompletionItemProvider {
    constructor() {
        this.trigger = "";
    }
    ...
    resolveCompletionItem(item, token) {
        let insertion = item.insertText.value;
        if (this.trigger === "\\") {
...
exports.default = DoxygenCompletionItemProvider;
/**
 * commands are a tuple of <command, snippet, documentation>
 */
DoxygenCompletionItemProvider.commands = [
    /*Special commands */
    ...
    ["code", ".${1:language-id}\n${2:code}\n@endcode", "Starts a block of code"],
...
DoxygenCompletionItemProvider.completionItems = (() => {
    const items = [];
...
//# sourceMappingURL=DoxygenCompletionItemProvider.js.map