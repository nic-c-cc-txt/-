...
const SnapshotTreeItem_1 = require("./lib/SnapshotTreeItem");
...
function childrenForVersions(versions) {
    return Object.values(versions)
        ...
        return new SnapshotTreeItem_1.SnapshotTreeItem(formatMtime(details['mtime']), details['size'] + ' bytes', details.toString(), {
