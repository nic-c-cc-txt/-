...
var add = function (_config, services, utils) {
    var gists = services.gists, insights = services.insights, logger = services.logger;
    var command = extension_commands_1.GistCommands.Add;
    var commandFn = function () { return __awaiter(_this, void 0, void 0, function () {
        var editor, selection, content, tmpFilename, filename, list, selected, err_1, error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    filename = (_a.sent()) ||
                        tmpFilename;
                    return [4, gists.getGists()];
                case 2:
                    list = _a.sent();
                    return [4, utils.input.quickPick(list)];
                case 3:
                    selected = _a.sent();
                    if (!selected) {
                    ...
                    return [4, services.gists.updateGist(selected.block.id, filename, content)];
                case 4:
                    _a.sent();
