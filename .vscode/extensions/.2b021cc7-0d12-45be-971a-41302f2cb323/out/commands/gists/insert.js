    ...
    var commandFn = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    gist = _a.sent();
                    return [4, utils_1.selectFile(gist)];
                case 4:
                    file = _a.sent();
                    if (!file) {
                    ...
                    return [4, utils_1.insertText(editor, file.content)];
                case 5:
                    _a.sent();
