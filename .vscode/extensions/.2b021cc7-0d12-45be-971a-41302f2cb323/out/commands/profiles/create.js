...
var create = function (_config, services, utils) {
    var insights = services.insights, logger = services.logger, profiles = services.profiles;
    var command = extension_commands_1.ProfileCommands.Create;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4, utils.input.prompt('Enter your enterprise API url')];
                case 2:
                    _a = _b.sent();
                    return [3, 4];
                case 3:
                ...
                case 4:
                    ...
                    return [4, utils.input.prompt('Enter your access token')];
                case 5:
                    key = _b.sent();
                    if (!key) {
                    ...
                    return [4, utils.input.prompt('Give this profile a name')];
                case 6:
                    name_1 = _b.sent();
                    if (!name_1) {
                    ...
                    profiles.add(name_1, key, url, true);
                    return [4, vscode_1.commands.executeCommand(extension_commands_1.StatusBarCommands.Update)];
                case 7:
                    _b.sent();
                    return [4, vscode_1.commands.executeCommand(extension_commands_1.GistCommands.UpdateAccessKey)];
                case 8:
                    _b.sent();
                ...
                case 9:
                    ...
                    utils.notify.error('Could Not Create Profile', "Reason: " + error.message);
                    return [3, 10];
                case 10: return [2];
            }
        });
