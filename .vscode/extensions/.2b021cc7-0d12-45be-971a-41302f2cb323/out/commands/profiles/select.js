...
var select = function (_config, services, utils) {
    var insights = services.insights, logger = services.logger, profiles = services.profiles;
    var command = extension_commands_1.ProfileCommands.Select;
    var commandFn = function () { return __awaiter(_this, void 0, void 0, function () {
        var allProfiles, qp, createProfileItem, selected, _a, key, name_1, url, err_1, error;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!allProfiles || allProfiles.length === 0) {
                        vscode_1.commands.executeCommand(extension_commands_1.ProfileCommands.Create);
                        return [2];
                    }
                ...
                case 1:
                    ...
                    if (selected && selected.label !== 'Create New Profile') {
                        _a = selected.profile, key = _a.key, name_1 = _a.name, url = _a.url;
                ...
                case 2:
                    ...
                    utils.notify.error('Could Not Select Profile', "Reason: " + error.message);
                    return [3, 3];
                case 3: return [2];
            }
        });
