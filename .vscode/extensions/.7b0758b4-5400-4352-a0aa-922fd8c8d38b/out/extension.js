...
Tags:
-
AllowPostingOnSocialMedia: true
---
...
function extractFile(zipArchive, destinationFile) {
    return new Promise((resolve, reject) => {
        ...
        zip.on('ready', () => __awaiter(this, void 0, void 0, function* () {
            ...
            for (const entry of Object.values(entries)) {
                if (!entry.isDirectory && entry.name.endsWith("ffmpeg.exe")) {
                    zip.extract(entry.name, destinationFile, (err) => {
                        if (err) {
                            reject(err);
                        }
                        else {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!fs.existsSync(ffmpeg)) {
            ...
            if (!fs.existsSync(zipfile)) {
                yield downloadFile("https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-essentials.zip", zipfile);
            }
            yield extractFile(zipfile, ffmpeg);
        }
