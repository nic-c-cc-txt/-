...
class Configuration {
     ...
     */
    ToJSON() {
        return JSON.stringify(pick(this, "IgnoreJavaScript", "IgnoreTypeScript", "AllowInlineConfig", "ReportUnusedDisableDirectives", "UseESLintRC", "ConfigFile", "AlwaysShowRuleFailuresAsWarnings", "SuppressWhileTypeErrorsPresent", "SuppressDeprecationWarnings", "SuppressConfigNotFoundError", "PackageManager", "LogLevel"));
    }
    /**
